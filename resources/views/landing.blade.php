      ...
      <article class="legal-card">
        <header class="legal-header">
          <div>
            ...
            <p>Останнє оновлення: 25 серпня 2026 року</p>
          </div>
          <form method="dialog">
        ...
        <div class="legal-body">
          ...
          <section class="legal-section">
            ...
            <ul>
              ...
              <li><strong>Результати роботи.</strong> Розпізнаний текст, висновки AI, попередження, список покупок, вибрані товари, стан синхронізації та зашифрована повна копія кошика перед його очищенням.</li>
          ...
          <section class="legal-section">
            ...
            <p>Скріншоти лежать у приватному сховищі, а події та результати — у базі даних. OAuth-токени, знімок профілю Сільпо й повна копія кошика перед очищенням зберігаються зашифрованими. Копія привʼязана до події й видаляється разом із нею. Дані кожного користувача відокремлені від чужих.</p>
        ...
        <div class="legal-body">
          ...
          <section class="legal-section">
            ...
            <ul>
              ...
              <li>Кожен новий похід Гуся починається з окремого підтвердження: сервіс читає кошик для зашифрованої копії, видаляє з нього всі товари й одразу перевіряє, що він порожній. Без цього підтвердження очищення не починається.</li>
              <li>Після очищення ви заново обираєте місце, магазин і час. Додавання підібраних товарів має окреме фінальне підтвердження; воно не оформлює замовлення, не оплачує його й не змінює бонуси, сертифікати чи промокоди.</li>
