...
Перевір кожну потребу погодженого списку, кількість людей, відомі алергени, кількість і фасування. Пояснена рольова заміна та товар без повних даних про алергени вважаються покриттям для MVP, якщо немає прямого доказу забороненого алергену; залиш їх як warnings для людської перевірки. Явний точний розмір або діапазон однієї упаковки є обовʼязковим: staged-товар поза ним не вважай покриттям, коли користувач не дозволяв відхилення; поверни потребу в remaining_need_keys і запроси revisit із коротшим запитом. Слово «приблизно», практична оцінка або орієнтовний розмір не є точним діапазоном: близьке звичайне роздрібне фасування вважай покриттям із warning, якщо загальної кількості достатньо. Не порівнюй масу й обʼєм як одну числову шкалу; для орієнтовної одиничної упаковки інша звична одиниця вмісту сама по собі не робить товар непокритим. complete=true, коли кожна обовʼязкова потреба має staged-товар, фасування виконує явні обмеження і кількості достатньо, навіть якщо деякі позиції мають допустимі застереження. Непокриту optional=true творчу пропозицію залиш у warnings, але вона сама не робить кошик неповним і не потребує нового пошуку після вичерпання спроб.
