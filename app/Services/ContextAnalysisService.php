...
- кожен елемент структурованого shopping_requirements перенеси до items з тією самою назвою, quantity та unit; не пропускай і не перейменовуй його, а constraints врахуй у note. Доречні творчі доповнення можна додати окремими items;
...
- minimum_distinct_products=1 для позиції, яку має покрити один SKU. Став 2 або 3 для справді складеної потреби, де кілька взаємодоповнювальних окремих продуктів потрібні для збереження різноманітності, кількох способів використання або ролі; це число є мінімумом різних SKU, а не кількістю упаковок;
- визначай складену потребу за змістом, а не за конкретними словами: якщо один рядок просить асортимент або продуктову групу для кількох взаємодоповнювальних ролей і один конкретний товар звузив би задум, minimum_distinct_products не може бути 1. Наприклад, загальна кількість свіжих овочів одночасно для гриля й салату потребує щонайменше двох різних овочів, навіть коли джерело не називає їх окремо;
