    ...
    <main class="mx-auto max-w-6xl px-4 py-6 sm:px-6 sm:py-10">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
                ...
                <p class="mt-2 max-w-2xl text-sm leading-6 text-muted">Запуски, рішення, питання, відповіді та зовнішні виклики для «{{ $event->title }}». Секрети й бінарні картинки сюди не потрапляють.</p>
            </div>
